...
@Injectable()
export class NearCrtService {
  private readonly logger = new Logger("NearCrtService");
  ...
  constructor(private configService: ConfigService) {
    ...
    this.session = new Session(configService.get('ID_CRT'), configService.get('PRIVATE_KEY_CRT'));
    this.init();
  }
